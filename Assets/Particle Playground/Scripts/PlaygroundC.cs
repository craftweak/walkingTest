...
namespace ParticlePlayground {
	...
	public class PlaygroundC : MonoBehaviour {
		...
		*************************************************************************************************************************************************/
		...
		public static float version = 2.24f;
		...
		*************************************************************************************************************************************************/
		...
		void OnEnable () {
			...
			#if UNITY_EDITOR
			InvokeRepeating("RefreshHieararchy", 1f, 1f);
			#endif
		}

		void OnDisable () {
			#if UNITY_EDITOR
			CancelInvoke("RefreshHieararchy");
			#endif
		}
	...
	public class ParticleStateC {
		...
		public void UpdateMatrix (bool isLocal) {
			stateTransformMx.SetTRS (isLocal?Vector3.zero:stateTransform.position, isLocal?Quaternion.identity:stateTransform.rotation, stateTransform.localScale);
		}
	...
	public class WorldObjectBaseC {
		...
		public void UpdateMatrix (bool isLocal) {
			transformMatrix.SetTRS(isLocal?Vector3.zero:transform.position, isLocal?Quaternion.identity:transform.rotation, transform.localScale);
		}
	}
	...
	public class PlaygroundTransformC {
		...
		public void UpdateMatrix () {
			if (available)
				transformMatrix.SetTRS(position, rotation, localScale);
		}
	...
	public enum ThreadMethod {
		...
		/// Note that this method will never bundle calculation calls unless specified in each individual particle systemâ€™s Particle Thread Method.
		/// </summary>
		OnePerSystem,
		/// <summary>
